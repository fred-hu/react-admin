    ...
    return (
      <Router>
        <div id='app-container'>
          ...
          <div id='app-main'>
            <div id='app-main-slider' style={{display:'inline-block'}}>
              <Navigation/>
            </div>
            <div id='app-main-content' style={{display:'inline-block',verticalAlign:'top',padding:20}}>
...
export default hot(module)(connect(mapStateToProps, mapDispatchToProps)(AppRouter));